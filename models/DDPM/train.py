...
def training_loop(ddpm, loader, n_epochs, optim, device, model, display=True, store_path="content/checkpoints/project_ddpm_best.ckpt", store_path2 = "/content/checkpoints/project_ddpm_regular.ckpt"):
    mse = nn.MSELoss()
